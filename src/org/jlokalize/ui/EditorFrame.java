...
import org.tools.ui.GraphicsUtils;
...
public class EditorFrame extends JFrame {
    ...
    public EditorFrame() {
        ...
        GraphicsUtils.setButtonKeyStroke(nextKeyButton, KeyStroke.getKeyStroke("F2"));
        GraphicsUtils.setButtonKeyStroke(nextNewKeyButton, KeyStroke.getKeyStroke("F3"));
    }
    ...
    private void initComponents() {
        ...
        keysTablePanelLayout.setHorizontalGroup(
            keysTablePanelLayout.createParallelGroup(Alignment.LEADING)
        ...
        keysTablePanelLayout.setVerticalGroup(
            keysTablePanelLayout.createParallelGroup(Alignment.LEADING)
            .addGroup(Alignment.TRAILING, keysTablePanelLayout.createSequentialGroup()
                .addComponent(keysScrollPane, GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
        ...
        valuePanelLayout.setHorizontalGroup(
            valuePanelLayout.createParallelGroup(Alignment.LEADING)
        ...
        valuePanelLayout.setVerticalGroup(
            ...
            .addGroup(valuePanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(valueScrollPane, GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE))
        );
        ...
        commentPanelLayout.setVerticalGroup(
            ...
            .addGroup(commentPanelLayout.createSequentialGroup()
                ...
                .addGroup(commentPanelLayout.createParallelGroup(Alignment.BASELINE)
                    ...
                    .addComponent(useDefaultCommentButton))
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(commentScrollPane, GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE))
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(toolBar, GroupLayout.DEFAULT_SIZE, 800, Short.MAX_VALUE)
            .addComponent(horizontalSplitPane, GroupLayout.DEFAULT_SIZE, 800, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(horizontalSplitPane, GroupLayout.DEFAULT_SIZE, 607, Short.MAX_VALUE))
        );
    ...
    private void newLangButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_newLangButtonActionPerformed
        ...
        if (root != null) {
            ...
            if (languageCodes != null) {
                ...
                if (country == null || country.length() != 2 || !CommonUtils.isLower(country)) {
